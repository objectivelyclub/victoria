...
namespace victoria.iOS
{
	public class Synth : UIViewController
	{
		...
		public Synth ()
		{
            Victoria.iOS.PlayMidi pl = new Victoria.iOS.PlayMidi();
            /*
...
//				TODO: CAShow
        ...
        public void LoadSF2()
        {
            ...
            var pcCommand = UInt32(0xC0 | channel);
        ...
        public void Write(byte[] msg)
        {
            if (msg.Length >2)
            {
                samplerUnit.MusicDeviceMIDIEvent(msg[0], msg[1], msg[2], 0);
            }
            else
            {
                samplerUnit.MusicDeviceMIDIEvent(msg[0], msg[1], 0, 0);
            }
        }
